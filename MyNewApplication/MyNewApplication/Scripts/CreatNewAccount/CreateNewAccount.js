...
function SignUp() {
    ...
    $.ajax({
        ...
        data: '{Id: "0",FirstName: "' + $("#TxtFName").val().trim() + '",LastName: "' + $("#TxtLName").val().trim() + '",ContactNo: "' + $("#TxtContactNo").val().trim() + '",EmailId: "' + $("#Email").val().trim() + '",password: "' + $("#TxtPassword").val().trim() + '",Gender: "' + $("#DDL_Gender").val() + '" }',
